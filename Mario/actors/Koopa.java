...
public class Koopa extends Actor implements Resettable {
    ...
    /**
     * Allows the Koopa to be attacked, attack or follow the otherActor.
    ...
    public ActionList allowableActions(Actor otherActor, String direction, GameMap map) {
        ...
        if(otherActor.hasCapability(Status.HOSTILE_TO_ENEMY) && getDisplayChar() == 'K') {
    ...
    /**
     * Creates a weapon for the unarmed Koopa.
