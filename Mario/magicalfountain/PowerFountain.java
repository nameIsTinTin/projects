...
/**
 * Class representing the PowerFountain
 */
public class PowerFountain extends Ground {
    ...
    private final ConsumeWaterAction consumeWaterAction;
    private final RefillBottleAction refillBottleAction;
    private int turn;
    ...
    public PowerFountain() {
        ...
        maxWaterCapacity=10;
        waterCapacity=10;
        consumeWaterAction=new ConsumeWaterAction(new Water("Power Water"));
        refillBottleAction=new RefillBottleAction(new Water("Power Water"));
        turn=0;
    }

    /**
     * Returns an Action List that the actor are allowed to perform on power fountain.
     *
    ...
    public void tick(Location location) {
        ...
        if (location.containsAnActor() && waterCapacity != 0) {
            ...
            System.out.println(actorOne + " refills/consumes water from Power Fountain " + "(" + waterCapacity + "/" + maxWaterCapacity + ")");}
